...
// Сделайте тоже самое с классом Manager (для него надо сделать свою таблицу)
        ...
        dbServiceManager.saveManager(new Manager("ManagerFirst", "FirstManagerParam"));

        var managerSecond = dbServiceManager.saveManager(new Manager("ManagerSecond", "SecondManagerParam"));
